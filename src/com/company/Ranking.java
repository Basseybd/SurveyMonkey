...
public class Ranking extends MultipleChoice implements java.io.Serializable {

    public String option;
    public String[] options;


    public Vector<String> createRanking(int questionNumber) {
        setPrompt(questionNumber);
        Output.outputString("Please input the options to be ranked with a '//' between each option" +
        ...
        MultipleChoice.add("Ranking");
        if(isTest==true) {
            RankOrMultipleChoiceAnswer();
            AntiOverrideCorrectAnswer();
            MultipleChoiceAnswerOptions.clear();
        }
        Output.outputString("you have created the following Ranking question\n" + this.prompt +"\n");
